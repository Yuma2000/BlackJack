...
public class Deck {
	...
	public static final int DECK_NUMBERS = Configuration.getConfiguration().getIntProperty("Deck.deckNumbers");
	...
	public static void main(String[] args) {
		System.out.println("デッキ数: " + DECK_NUMBERS);
		Deck cardsDeck = new Deck();
		cardsDeck.setupDeck();
		System.out.println("カード数: " + cardsDeck.getCardsNumber());
	}
